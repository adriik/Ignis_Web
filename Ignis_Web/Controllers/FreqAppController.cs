...
namespace Ignis_Web.Controllers
{
    public class FreqAppController : Controller
    {
        ...
        FreqAccess freqAccess = new FreqAccess();
        WspAccess wspAccess = new WspAccess();
        SetReqAccess setReqAccess = new SetReqAccess();
        ...
        public ActionResult FreqAppka(item username)
        {
            ...
            freqAccess.SetFreq(ListaGraczy, FirstBossLists, SecondBossLists, ThirdBossLists, FourthBossLists, FifthBossLists, Dungeon);
        ...
        public ActionResult Przeliczenia_Coquina(item username)
        {
            ...
            freqAccess.SetCoquin(username, dungeonName);
        ...
        {
            string dungeonName = TempData["Wybrana_Instancja"].ToString();
            freqAccess.SetTotalFreq(dungeonName);
        ...
        {
            string dungeonName = TempData["Wybrana_Instancja"].ToString();
            freqAccess.SetAllStat(dungeonName);
