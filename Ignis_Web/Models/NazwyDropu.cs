...
namespace Ignis_Web.Models
{
    public class NazwyDropu
    {
        ...
        public static List<NazwyDropu> GetItems()
        {
            ...
            new NazwyDropu{Id=17, Name="Laska Magowa", Category="Bronie"},
            new NazwyDropu{Id=18, Name="Laska Healowa", Category="Bronie"},
            new NazwyDropu{Id=19, Name="Topór 2h", Category="Bronie"},
            new NazwyDropu{Id=20, Name="Sztylet", Category="Bronie"},
            new NazwyDropu{Id=21, Name="Kusza", Category="Bronie"},
            new NazwyDropu{Id=22, Name="Różdżka Magowa", Category="Bronie"},
            new NazwyDropu{Id=23, Name="Różdżka Healowa", Category="Bronie"},
            new NazwyDropu{Id=24, Name="sta/hp 251", Category="Stat"},
            new NazwyDropu{Id=25, Name="sta/wis 251", Category="Stat"},
            new NazwyDropu{Id=26, Name="sta/patt 251", Category="Stat"},
            new NazwyDropu{Id=27, Name="str/patt 251", Category="Stat"},
            new NazwyDropu{Id=28, Name="dex/patt 251", Category="Stat"},
            new NazwyDropu{Id=29, Name="int/matt 251", Category="Stat"},
            new NazwyDropu{Id=30, Name="int/matt", Category="Stat"},
